...
/**
 * Created by biswas on 24/03/2017.
 */

public class CAutoCompleteView extends AutoCompleteTextView {
    ...
    public CAutoCompleteView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CAutoCompleteView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Typeface selectTypeface(Context context, String fontName,int fStyle) {
        ...
        if(fontName==null)
            return FontCache.getTypeface("poppins/R.ttf",context);
        ...
        switch (fStyle) {
            ...
            case CTextView.FSTYLE_SEMIBOLD:
                return FontCache.getTypeface(fontName+"/SB.ttf",context);default:
                return FontCache.getTypeface(fontName+"/R.ttf", context);
        }
